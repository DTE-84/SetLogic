...
function MealGenerator() {
	...
	const handleGenerate = async () => {
		...
		try {
			...
			setPlan(result);
			console.log("Plan state set to:", result);
		} catch (error) {
							...
							<div className='section-content'>
								...
								<div className='form-group'>
									...
									<small className='field-hint'>
										Important for nutrient-drug interactions (e.g., grapefruit +
										statins)
									</small>
								</div>
								...
								<div className='form-group'>
									...
									/>
									<small className='field-hint'>
										List only true allergies, not preferences or intolerances
									</small>
								</div>
								...
								<div className='form-group'>
									...
									<select
										...
										value={formData.pregnancy_breastfeeding}
										onChange={handleChange}>
										<option value='none'>Not Applicable</option>
										<option value='pregnant_1st'>
											Pregnant - 1st Trimester
										</option>
										<option value='pregnant_2nd'>
											Pregnant - 2nd Trimester
										</option>
										<option value='pregnant_3rd'>
									...
									<div className='form-group'>
										...
										<select
											...
											<option value='aggressive'>
												Aggressive (Fast results, harder adherence)
											</option>
											<option value='moderate'>
												Moderate (Balanced approach)
											</option>
											<option value='slow'>
												Slow & Steady (Easy adherence, sustainable)
											</option>
										</select>
									</div>
								</div>
								...
								<div className='form-row'>
									<div className='form-group'>
										...
										<select
											...
											<option value='moderate'>
												Moderate (4-5 days/week exercise)
											</option>
											<option value='very_active'>
												Very Active (6-7 days/week intense training)
											</option>
						...
						{expandedSections.nutrition && (
							<div className='section-content'>
								<small className='section-hint'>
									Leave blank to have AI calculate optimal macros based on your
									goals
								</small>
								<div className='form-row'>
									<div className='form-group'>
					...
					<div className='form-section'>
						...
						{expandedSections.dietary && (
							<div className='section-content'>
								<div className='form-row'>
									...
									<div className='form-group'>
										...
										<select
											...
											value={formData.cooking_ability}
											onChange={handleChange}>
											<option value='beginner'>
												Beginner (Microwave, basic prep)
											</option>
											<option value='intermediate'>
												Intermediate (Can follow recipes)
											</option>
											<option value='advanced'>
												Advanced (Comfortable with complex cooking)
											</option>
										</select>
									</div>
								</div>
								...
								<div className='form-group'>
									<label>
										Food Preferences (What you actually like eating)
									</label>
									<textarea
						...
						{expandedSections.micros && (
							<div className='section-content'>
								<div className='form-group'>
									...
									/>
									<small className='field-hint'>
										From recent blood work or doctor diagnosis
									</small>
								</div>
								...
								<div className='form-group'>
									...
									/>
									<small className='field-hint'>
										Include doses to check for redundancy/toxicity
									</small>
								</div>
							</div>
						)}
									...
									<div className='form-group'>
										...
										<select
											...
											<option value='extensive'>
												Extensive (1+ hour/day, batch cooking)
											</option>
										</select>
									</div>
							...
							{plan.split("\n").map((line, index) => {
								if (line.startsWith("###")) {
									return (
										<h4
											key={index}
											className='text-xl font-black mt-8 mb-4 text-primary uppercase tracking-tighter'>
											{line.replace("###", "").trim()}
										</h4>
									);
								}
								if (line.startsWith("##")) {
									return (
										<h3
											key={index}
											className='text-2xl font-black mt-10 mb-6 text-white uppercase tracking-tighter border-b border-primary/20 pb-2'>
											{line.replace("##", "").trim()}
										</h3>
									);
								}
								if (line.startsWith("#")) {
									return (
										<h2
											key={index}
											className='text-3xl font-black mt-12 mb-8 text-white uppercase tracking-tight'>
											{line.replace("#", "").trim()}
										</h2>
									);
								}
								if (line.startsWith("-") || line.startsWith("*")) {
									return (
										<li
											key={index}
											className='ml-4 mb-2 text-muted-foreground list-none flex gap-2'>
